...
module('Integration | Component | polaris layout', function(hooks) {
  ...
  test('it renders the correct HTML when using annotated sections in inline form', async function(assert) {
    await render(hbs`
      {{#polaris-layout as |layout|}}
  ...
  test('it renders the correct HTML when using annotated sections in block form', async function(assert) {
    await render(hbs`
      {{#polaris-layout as |layout|}}
