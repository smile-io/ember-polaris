...
module('Integration | Component | polaris badge', function(hooks) {
  ...
  test('it renders the correct HTML in basic inline usage', async function(assert) {
    ...
    assert.dom(badgeSelector).hasText('Inline badge', 'renders the correct badge content');
  });
  ...
  test('it renders the correct HTML in basic block usage', async function(assert) {
    ...
    assert.dom(badgeSelector).exists({ count: 1 }, 'renders one badge');
    assert.dom(badgeSelector).hasText('Block badge', 'renders the correct badge content');
  });
  ...
  test('it renders the correct HTML when status is set', async function(assert) {
    ...
    let visuallyHiddenSelector = buildNestedSelector(badgeSelector, 'span.Polaris-VisuallyHidden');
    ...
    assert.dom(visuallyHiddenSelector).doesNotExist('status not set - does not render any visually hidden components');
    ...
    assert.dom(visuallyHiddenSelector).doesNotExist('status set to default - does not render any visually hidden components');

    // With status set to success:
    //  - should apply success status class
    //  - should render visually hidden component with success text
    this.set('status', 'success');
    assert.dom(badgeSelector).hasClass(
  ...
  test('it renders the correct HTML when progress is set', async function(assert) {
    ...
    let badgePipVisuallyHiddenSelector = buildNestedSelector('.Polaris-Badge__Pip', '.Polaris-VisuallyHidden');
    ...
    assert.dom(badgePipSelector).doesNotExist('progress not set - does not render a pip div');
    assert.dom(badgePipVisuallyHiddenSelector).doesNotExist('progress not set - does not render a pip visually hidden component');
    ...
    assert.dom(badgePipSelector).doesNotExist('progress set to default - does not render a pip div');
    assert.dom(badgePipVisuallyHiddenSelector).doesNotExist('progress set to default - does not render a pip visually hidden component');
    ...
    assert.dom(badgePipSelector).exists('progress set to incomplete - renders one pip div');
    assert.dom(badgePipVisuallyHiddenSelector).exists('progress set to incomplete - renders one pip visually hidden component');
    assert.dom(badgePipVisuallyHiddenSelector).hasText(
      'Incomplete',
    ...
    assert.dom(badgePipSelector).exists('progress set to partiallyComplete - renders one pip div');
    assert.dom(badgePipVisuallyHiddenSelector).exists('progress set to partiallyComplete - renders one pip visually hidden component');
    assert.dom(badgePipVisuallyHiddenSelector).hasText(
      'Partially complete',
    ...
    assert.dom(badgePipSelector).exists('progress set to complete - renders one pip div');
    assert.dom(badgePipVisuallyHiddenSelector).exists('progress set to complete - renders one pip visually hidden component');
    assert.dom(badgePipVisuallyHiddenSelector).hasText(
      'Complete',
