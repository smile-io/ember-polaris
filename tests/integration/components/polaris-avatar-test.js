...
module('Integration | Component | polaris avatar', function(hooks) {
  ...
  test('it renders a correctly-styled avatar', async function(assert) {
    await render(hbs`{{polaris-avatar name=name initials=initials}}`);
  ...
  test('it renders a correctly-sized avatar', async function(assert) {
    await render(hbs`{{polaris-avatar size=size}}`);
  ...
  test('it renders the correct accessibility label', async function(assert) {
    await render(hbs`
      {{polaris-avatar
        name=name
        initials=initials
  ...
  test('it renders the correct initials markup', async function(assert) {
    await render(hbs`{{polaris-avatar initials=initials}}`);
  ...
  test('it renders the correct image markup', async function(assert) {
    await render(hbs`{{polaris-avatar
      source=source
      customer=customer
    ...
    assert.notOk(
      image,
      'without source or customer - does not render any image'
    );
