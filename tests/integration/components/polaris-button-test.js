...
test('renders the correct HTML', function(assert) {
  ...
  let buttonText = this.$('button.Polaris-Button .Polaris-Button__Content').text().trim();
  ...
  buttonText = this.$('button.Polaris-Button .Polaris-Button__Content').text().trim();
  ...
  buttonText = this.$('a.Polaris-Button .Polaris-Button__Content').text().trim();
