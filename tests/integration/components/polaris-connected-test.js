...
const primaryContentSelector = buildNestedSelector(connectedContainerSelector, '.Polaris-Connected__Item--primary');

// These selectors are for when both `left` AND `right` attributes are passed-in
const leftContentSelector = buildNestedSelector(connectedContainerSelector, '.Polaris-Connected__Item--connection:first-of-type');
const rightContentSelector = buildNestedSelector(connectedContainerSelector, '.Polaris-Connected__Item--connection:last-of-type');
