...
export default Component.extend(
  ...
  ContextBoundTasksMixin,
  {
    ...
    characterCount: or('normalizedValue.length', 0),
    ...
    debouncedHandleButtonPress(onChange) {
      onChange();
    },
    ...
    actions: {
      ...
      handleButtonPress(onChange) {
        this.debounceTask('debouncedHandleButtonPress', 200, onChange);
      },

      // Unimplemented because we're using `debounceTask` in `handleButtonPress`
      // rather than setting and clearing timeouts manually in the window.
      handleButtonRelease() {},
